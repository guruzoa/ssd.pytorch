...
VIS_ROOT = osp.join(HOME, "data/VisDrone/2019/Task2/")

# for making bounding boxes pretty
COLORS = ((255, 0, 0, 128), (0, 255, 0, 128), (0, 0, 255, 128),
          (0, 255, 255, 128), (255, 0, 255, 128), (255, 255, 0, 128))

# VIS_CLASSES = (  # always index 0
...
# VIS_ROOT = osp.join(HOME, "data/VOCdevkit/")
...
class VisDroneDetection(data.Dataset):
    ...
    def __init__(self, root,
                 image_sets=['VisDrone2019-VID-train_short'],
                 preproc=None, target_transform=AnnotationTransform(),
        ...
        self.img_path = list()
        self.img_shape = (300, 300)     # TODO : set the image size automatically
        self.anno = dict()
